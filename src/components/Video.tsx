...
export function Video(props: VideoProps) {
    ...
    return (
        <div className="flex-1 container">
            <div className="bg-black flex justify-center w-full min-h-[300px] sm:min-h-[400px] md:min-h-[500px]">
                <div className="w-full max-w-[900px] max-h-[60vh] aspect-video">
                    <Player>
                        <Youtube videoId={data.lesson.videoId} />
                        <DefaultUi />
                    </Player>
            ...
            <div className="p-8 max-w-[1100px] mx-auto px-4">
                <div className="flex flex-col items-center sm:items-start gap-16 sm:flex-row">
                    <div className="flex-1">
                        <h1 className="text-2xl font-bold ">{data.lesson.title} </h1>
                        <p className="mt-4 text-gray-200 leading-relaxed">
                            {data.lesson.description}
